...
struct qt_meta_stringdata_CLASSVisualizationWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSVisualizationWindowENDCLASS = QtMocHelpers::stringData(
    "VisualizationWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSVisualizationWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject VisualizationWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSVisualizationWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSVisualizationWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSVisualizationWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *VisualizationWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSVisualizationWindowENDCLASS.stringdata0))
